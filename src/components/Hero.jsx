        ...
        <SwiperSlide>
          <div className="w-full relative">
            ...
            <img
              ...
              alt="Slider Image"
            />
            <div className="absolute top-[280px] left-1/2 -translate-x-1/2 md:top-10 lg:top-1/2 lg:-translate-y-1/2 md:left-1/2 transform max-sm:text-[#334155] bg-gray-950 bg-opacity-35 p-6 rounded-3xl md:text-white text-center">
              ...
              <Link
                ...
                className="btn bg-white max-sm:bg-[#334155] max-sm:text-white border md:bg-blue-100 text-[#5896d3] hover:bg-blue-200 hover:text-[#334155] px-6 py-3 rounded-lg"
              >
                Explore Now
              </Link>
            </div>
         ...
         <SwiperSlide>
          <div className="w-full  relative">
            ...
            <img
              ...
              alt="Slider Image"
            />
            <div className="absolute top-[280px] left-1/2 -translate-x-1/2 md:top-[300px] lg:top-[250px] md:left-1/2 transform md:-translate-y-1/2 lg:-translate-x-1/2 max-sm:text-[#334155] md:text-white text-center bg-gray-950 bg-opacity-25 p-6 rounded-3xl">
              ...
              <Link
                to="/category/Fiction"
                className="btn max-sm:mt-10  max-sm:bg-[#334155] md:bg-[#5896d3] text-blue-100 hover:bg-blue-300 px-6 py-3 rounded-lg"
              >
                Explore Now
              </Link>
            </div>
